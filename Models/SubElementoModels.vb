...
Namespace Custodia.Models
    Public Class SubElementoContext
        Inherits DbContext
        ...
        Public Property SubElementoSeguridad As DbSet(Of SubElementosModel)

    End Class

    <Table("subelementos")> _
    Public Class SubElementosModel
        ...
        <Display(Name:="Tiene Clave")> _
        Public Property TieneClave As Integer

        <Display(Name:="Tiene Llave")> _
        Public Property TieneLlave As Integer
