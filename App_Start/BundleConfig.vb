...
Public Class BundleConfig
    ...
    Public Shared Sub RegisterBundles(ByVal bundles As BundleCollection)
        ...
        bundles.Add(New ScriptBundle("~/bundles/UIElements").Include(
                  "~/Scripts/datepicker.js"))


        bundles.Add(New StyleBundle("~/Content/css").Include(
                     "~/Content/site.css",
                     "~/Content/f_awesome.css",
                     "~/Content/fonts.css",
        ...
        bundles.Add(New ScriptBundle("~/bundles/footer/index").Include("~/Scripts/index.js"))
